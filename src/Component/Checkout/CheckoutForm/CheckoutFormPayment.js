    ...
    return (
        <div className="form-payment-wrapper">
            ...
            <form className="form-payment-method">
                ...
                <label>
                    <input type="radio" name="payment_method" id="payment_online" value="payment_online"/>
                    <label htmlFor="payment_online">Thanh toán online</label>
                </label>
                <label>
                    <input type="radio" name="payment_method" id="payment_onspot" value="payment_onspot"/>
